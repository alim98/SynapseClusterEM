...
class SynapseDataset(Dataset):
    def __init__(self, vol_data_dict: dict, synapse_df: pd.DataFrame, processor,
                 ...
                 size_tolerance: float = 0.1, vesicle_fill_threshold: float = 95.0):
        ...
        self.vesicle_fill_threshold = vesicle_fill_threshold
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            print(f"Error processing frames for sample {idx}, bbox {bbox_name}: {e}")
            import traceback
            traceback.print_exc()
            return torch.zeros((self.num_frames, 1, self.subvol_size, self.subvol_size), dtype=torch.float32), syn_info, bbox_name
