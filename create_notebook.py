...
# Add markdown cell for cloning repository
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for cloning repository
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for installing dependencies
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for installing package in development mode
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for mounting Google Drive
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for mounting Google Drive
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for setting up data paths
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for setting up data paths
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for checking data availability
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for checking data availability
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for uploading data
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for uploading data
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for running global normalization
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for running global normalization
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for checking global normalization results
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for checking global normalization results
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for running analysis with global normalization
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for running analysis with global normalization
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for visualizing samples
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for visualizing samples
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for displaying results
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for displaying results
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for loading and exploring clustering results
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for loading and exploring clustering results
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for visualizing representative samples from each cluster
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for visualizing representative samples from each cluster
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for displaying representative samples from each cluster
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for displaying representative samples from each cluster
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for saving results back to Google Drive
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for saving results back to Google Drive
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
...
# Add markdown cell for running the complete workflow script
notebook['cells'].append({
    'cell_type': 'markdown',
    'metadata': {},
    'source': [
...
# Add code cell for running the complete workflow script
notebook['cells'].append({
    'cell_type': 'code',
    'metadata': {},
    'source': [
